...
export const metadata: Metadata = {
  ...
  description: "Website modernization, workflow automation, systems integration, and operational dashboards — practical digital systems built for small and mid-sized businesses.",
};
...
function WebsiteIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 44 44" fill="none" aria-hidden>
      ...
      <rect x="10" y="20" width="10" height="8" rx="1" stroke="#6FAFA6" strokeWidth="1.2" />
      <line x1="23" y1="21" x2="34" y2="21" stroke="#6FAFA6" strokeWidth="1.2" strokeLinecap="round" />
      <line x1="23" y1="24.5" x2="34" y2="24.5" stroke="#6FAFA6" strokeWidth="1.2" strokeLinecap="round" />
      <line x1="14" y1="38" x2="30" y2="38" stroke="#6FAFA6" strokeWidth="1.4" strokeLinecap="round" />
...
function MobileIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 44 44" fill="none" aria-hidden>
      <rect x="13" y="4" width="18" height="36" rx="3" stroke="#6FAFA6" strokeWidth="1.4" />
      <line x1="13" y1="10" x2="31" y2="10" stroke="#6FAFA6" strokeWidth="1.2" />
      <line x1="13" y1="34" x2="31" y2="34" stroke="#6FAFA6" strokeWidth="1.2" />
      <circle cx="22" cy="37" r="1.5" fill="#6FAFA6" opacity="0.7" />
      <line x1="19" y1="17" x2="25" y2="17" stroke="#6FAFA6" strokeWidth="1.4" strokeLinecap="round" />
      <line x1="17" y1="21" x2="27" y2="21" stroke="#6FAFA6" strokeWidth="1.2" strokeLinecap="round" />
      <line x1="17" y1="25" x2="27" y2="25" stroke="#6FAFA6" strokeWidth="1.2" strokeLinecap="round" />
    </svg>
  );
}
...
function DashboardIcon() {
  return (
    <svg width="36" height="36" viewBox="0 0 44 44" fill="none" aria-hidden>
      ...
      <polyline points="9,26 16,17 23,21 33,11" fill="none" stroke="#6FAFA6" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <circle cx="33" cy="11" r="2.5" fill="#6FAFA6" opacity="0.75" />
    </svg>
  );
}
    ...
    <div className="min-h-screen bg-[#0B1220] text-[#F4F7F9]">
      ...
      <section className="pt-36 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-[#6FAFA6] text-xs font-semibold tracking-widest uppercase mb-4">Business Transformation Services</div>
      ...
      <section className="pb-24 px-6 -mt-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {pillars.map((p) => (
              <div key={p.title} className="bg-[#1A2333] border border-[#AEB7C2]/15 rounded-xl p-8 flex flex-col hover:border-[#6FAFA6]/60 hover:shadow-[0_8px_32px_rgba(111,175,166,0.15)] hover:-translate-y-1 transition-[border-color,box-shadow,transform] duration-300">
                ...
                <ul className="space-y-2.5 mb-7 flex-1">
                  {p.capabilities.map((c) => (
                    <li key={c} className="flex items-center gap-2.5 text-sm text-[#AEB7C2]">
                      <span className="w-1 h-1 rounded-full bg-[#6FAFA6] flex-shrink-0" />
                      {c}
                    </li>
                  ))}
                </ul>
                <div className="pt-5 border-t border-[#AEB7C2]/10 mt-auto">
                  {p.stat && (
                    <div className="mb-4">
                      ...
                      <div className="text-[#6FAFA6] text-sm font-medium">{p.stat}</div>
                    </div>
                  )}
                  {p.cta && (
                    <a
                      href={p.cta.href}
                      className="inline-flex items-center gap-2 bg-[#6FAFA6] hover:bg-[#83BDB5] text-[#0B1220] font-bold text-sm px-5 py-2.5 rounded-lg transition-colors duration-200"
                    >
                      {p.cta.label} →
                    </a>
                  )}
      ...
      <section className="py-24 px-6 bg-[#1A2333]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <div className="text-[#6FAFA6] text-xs font-semibold tracking-widest uppercase mb-3">Performance Dashboards</div>
            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                {kpiCards.map((k) => (
                  <div key={k.label} className="bg-[#1A2333] border border-[#AEB7C2]/10 rounded-xl p-5">
                    ...
                    <div className={`text-xs font-medium ${k.up ? "text-[#6FAFA6]" : "text-[#AEB7C2]/60"}`}>
                      {k.up ? "↑" : "↓"} {k.trend}
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-[#1A2333] border border-[#AEB7C2]/10 rounded-xl overflow-hidden">
                <div className="px-5 py-3 border-b border-[#AEB7C2]/10 flex items-center justify-between">
                  ...
                  <span className="text-[#6FAFA6] text-xs">Live</span>
                </div>
                      ...
                      <div className="flex items-center gap-3">
                        <div className="w-16 sm:w-20 md:w-24 bg-[#0B1220] rounded-full h-1.5 overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${row.pct}%`,
                              background: row.pct === 100 ? "#6FAFA6" : "#AEB7C2",
                            }}
                          />
                        </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <div className="text-[#6FAFA6] text-xs font-semibold tracking-widest uppercase mb-3">Workflow Automation</div>
          ...
          <div className="bg-[#1A2333] border border-[#AEB7C2]/15 rounded-2xl p-8 sm:p-10">
            ...
            <div className="mt-8 pt-6 border-t border-[#AEB7C2]/10 flex flex-col sm:flex-row gap-6">
              ...
              <div className="text-center sm:text-left">
                <div className="text-[#6FAFA6] text-xs uppercase tracking-wider mb-1 font-semibold">After Automation</div>
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="text-[#6FAFA6] font-bold text-xl">97%</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-[#1A2333]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <div className="text-[#6FAFA6] text-xs font-semibold tracking-widest uppercase mb-3">Systems Integration</div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="text-[#6FAFA6] text-xs font-semibold tracking-widest uppercase mb-4">Get Started</div>
