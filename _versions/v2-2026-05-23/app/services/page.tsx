...
export const metadata: Metadata = {
  ...
  description:
    "From modern websites to internal automation and dashboards — H4 Systems delivers AI-assisted digital solutions built to help SMBs operate smarter and grow faster.",
};
...
const mainServices: ServiceDef[] = [
  {
    ...
    title: "Modern Customer Experiences",
    desc: "Modern, mobile-friendly websites built for clarity, performance, usability, and customer conversion.",
    bullets: [
      "Legacy website rebuilds and redesigns",
      "Mobile-responsive layouts",
      "Performance-focused implementation",
      "Clear calls-to-action and customer journeys",
    ],
  },
  {
    Icon: AutomationIcon,
    ...
    desc: "Practical automation that connects tools, reduces repetitive work, and improves operational consistency.",
    bullets: [
      "Lead routing and intake workflows",
      "CRM and system integrations",
      "Internal notifications and follow-ups",
  ...
  },
  {
    ...
    desc: "Dashboards and reporting systems that help business owners see performance, trends, and operational priorities.",
    bullets: [
      "Executive dashboards",
      "KPI definition and tracking",
      "Real-time reporting pipelines",
      "Budget, performance, and activity views",
    ],
  },
  {
    Icon: AIDevIcon,
    category: "Faster Digital Delivery",
    title: "AI-Assisted Development",
    desc: "AI-assisted workflows used to accelerate planning, prototyping, development, and implementation.",
    bullets: [
      "Faster prototyping",
