...
function AutomationIcon() {
  return (
    <svg width="40" height="40" viewBox="0 0 44 44" fill="none" aria-hidden>
      <rect x="5" y="18" width="9" height="9" rx="1.5" stroke="#6FAFA6" strokeWidth="1.4" />
      <rect x="18" y="7" width="9" height="9" rx="1.5" stroke="#6FAFA6" strokeWidth="1.4" />
      <rect x="18" y="29" width="9" height="9" rx="1.5" stroke="#6FAFA6" strokeWidth="1.4" />
      <rect x="31" y="18" width="9" height="9" rx="1.5" stroke="#6FAFA6" strokeWidth="1.4" />
      <line x1="14" y1="22.5" x2="18" y2="22.5" stroke="#6FAFA6" strokeWidth="1.2" />
      <line x1="22.5" y1="16" x2="22.5" y2="18" stroke="#6FAFA6" strokeWidth="1.2" />
      <line x1="22.5" y1="29" x2="22.5" y2="29" stroke="#6FAFA6" strokeWidth="1.2" />
      <line x1="27" y1="22.5" x2="31" y2="22.5" stroke="#6FAFA6" strokeWidth="1.2" />
      <line x1="22.5" y1="22.5" x2="22.5" y2="29" stroke="#6FAFA6" strokeWidth="1.2" />
    </svg>
  );
}
...
function ServiceCard({ service, delay }: { service: Service; delay: number }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-[#0B1220] border border-[#AEB7C2]/10 rounded-2xl p-8 flex flex-col hover:border-[#6FAFA6]/60 hover:shadow-[0_8px_32px_rgba(111,175,166,0.15)] hover:-translate-y-1 transition-[border-color,box-shadow,transform] duration-300"
    >
      {/* Icon */}
      ...
      <a
        href={href}
        className="inline-flex items-center gap-2 font-mono text-[#6FAFA6] text-[10px] font-bold tracking-[0.2em] uppercase group-hover:gap-3 transition-[gap] duration-200"
      >
        <span>{cta}</span>
  ...
  return (
    <section className="bg-[#1A2333] pt-16 pb-28 px-6 lg:px-10">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <p className="font-mono text-[#6FAFA6] text-[13px] font-bold tracking-[0.28em] uppercase mb-4">
            What We Do
          </p>
